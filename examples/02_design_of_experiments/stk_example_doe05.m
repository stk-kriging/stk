...
%
% Evaluations points are chosen sequentially using the Expected Quantile
% Improvement (EQI) criterion, starting from an initial design of N0 = 3 points.
...
%              Tom Assouline  <tom.assouline@supelec.fr>
