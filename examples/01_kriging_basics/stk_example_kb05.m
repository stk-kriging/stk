...
title ('Unconditional sample paths');  stk_labels ('input variable x', 'response z');
...
title ('Observations');  stk_labels ('input variable x', 'response z');

% Display the conditional sample paths
subplot (2, 2, 3);  plot (xt, zsimc, 'LineWidth', 2);  legend off;  hold on;
plot (xi, zi, 'ko', 'LineWidth', 3, 'MarkerSize', 4, 'MarkerFaceColor', 'k');
title ('Conditional sample paths');  stk_labels ('input variable x', 'response z');
