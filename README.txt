...
o Requirements and recommendations for use with GNU Octave
    ...
    The Octave-forge 'statistics' package is currently required to run 
    the STK (for the pdist() function).
...
o Content
    ...
    products. However,  some advanced features, such  as the possibility
    to use parallel computing in  some functions, are not available when
    using Octave.
    ...
    a. The  first part is the  implementation of a  number of covariance
       ...
       covariances:    stationary    or   non-stationary    covariances,
       anisotropic   covariances,  generalized  covariances,   etc.   In
       version 1.0 of the STK, only the Matern covariance (at any order)
       is available.
    ...
    c. The third part consists of prediction procedures. In version 1.0,
       the STK  has been  optimized to deal  with moderately  large data
       sets.

References

J. Bect, D. Ginsbourger, L. Li, V. Picheny, and E. Vazquez. Sequential
   design of computer experiments for the estimation of a probability of
   failure. Statistics and Computing, pages 1-21, 2011. DOI:
   10.1007/s11222-011-9241-4.

D. R. Jones, M. Schonlau, and J. William. Efficient global optimization
