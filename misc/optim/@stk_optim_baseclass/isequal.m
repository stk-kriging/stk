...
b = isa (x, 'stk_optim_baseclass') && strcmp (class (y), class (x)) ...
    && isequal (x.does_boxconstrained, y.does_boxconstrained) ...
    && isequal (x.does_unconstrained, y.does_unconstrained);
