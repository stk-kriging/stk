...
%   using the anisotropic Matern covariance kernel with parameters PARAM. The
...
%
%     * PARAM(2+i) = - log (RHO(i)), where RHO(i) is the range parameter for the ith dimension.
%
...
%!error stk_materncov_aniso(param, x, y, -1, false, pi^2);
