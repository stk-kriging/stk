...
%    space.
%
% CALL: K = stk_discretecov (PARAM, X, Y, -1, PAIRWISE)
%
%    computes the covariance vector between the sets of locations X and Y.
%    The output K is a vector of length N, where N is the common length of
%    X and Y.
