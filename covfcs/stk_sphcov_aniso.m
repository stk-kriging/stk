...
%!error K0 = stk_sphcov_aniso (param, x, y, -1, false, pi^2);
...
%! K2 = stk_sphcov_aniso (param, struct ('a', u), struct ('a', v), -1);
%! K3 = stk_sphcov_aniso (param, stk_dataframe (u), stk_dataframe (v), -1);
%! assert (isequal (K1, K2));
%! assert (isequal (K1, K3));
