...
%
% STK_MATERNCOV52_ISO computes a Matern covariance between two random vectors
...
function k = stk_materncov52_iso(param, x, y, diff)
...
%!error stk_materncov52_iso(param, x, y, -1, pi^2);
