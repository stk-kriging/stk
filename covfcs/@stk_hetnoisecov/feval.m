...
if ~ isempty (cov.prop.varfun),
    % in this case we have a function that gives
    % the value of the variance at any point
    ...
    % otherwise cov.variance is a vector of variances
    % corresponding to the locations cov.x
    if isequal (cov.prop.x, x),
        ...
        stk_error ('Improper use of this kind of covariance object.', ...
            'IncorrectArgument');
    end
end
