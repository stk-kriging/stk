...
%!error [KK, PP] = stk_covmat_noise (model, x1, [], -1, false, pi);
...
%!error [KK, PP] = stk_covmat_noise (model, x1, x1, -1, false, pi);
...
%!error [KK, PP] = stk_covmat_noise (model, x1, x2, -1, false, pi);
