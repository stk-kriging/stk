...
%!test  [Ka, Pa] = stk_covmat_latent (model, x0);                        % (1)
%!test  [K1, P1] = stk_covmat_latent (model, x0, []);
%!test  [K2, P2] = stk_covmat_latent (model, x0, [], -1);
%!test  [K3, P3] = stk_covmat_latent (model, x0, [], -1, false);
%!error [KK, PK] = stk_covmat_latent (model, x0, [], -1, false, pi);
...
%!test  [Kb, Pb] = stk_covmat_latent (model, x0, x0);                    % (2)
%!test  [K1, P1] = stk_covmat_latent (model, x0, x0, -1);
%!test  [K2, P2] = stk_covmat_latent (model, x0, x0, -1, false);
%!error [KK, PP] = stk_covmat_latent (model, x0, x0, -1, false, pi);
...
%!test  [Kc, Pc] = stk_covmat_latent (model, x0, x1);                    % (3)
%!test  [K1, P1] = stk_covmat_latent (model, x0, x1, -1);
%!test  [K2, P2] = stk_covmat_latent (model, x0, x1, -1, false);
%!error [KK, PP] = stk_covmat_latent (model, x0, x1, -1, false, pi);
...
%!test [Ka, Pa] = stk_covmat_latent (model2, x0);                      % (1')
%!test [Kb, Pb] = stk_covmat_latent (model2, x0, x0);                  % (2')
